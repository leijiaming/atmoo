...
public interface Api {
    ...
    @GET("/atmoo/homeList/")
    Observable<HomeList> atmooHomeListData(@Query("vedioTypeId")String channelId);
    ...
    @GET("/atmoo/detail")
    Observable<VideoDetail> atmooDetailData(@Query("id")String videoId);
    @GET("/atmoo/detail/related")
    Observable<VideoRelated> atmooDetailRelatedData(@Query("id")String videoId);
    @GET("/atmoo/comment/list")
    Observable<Comment> atmooCommentListData(@Query("userId")String userId, @Query("id")String id, @Query("pageNum")String pageNum, @Query("pageSize")String pageSize);
    @GET("/atmoo/comment/add")
    Observable<Result> atmooCommentAddData(@Query("id")String videoId,@Query("userId")String userId,@Query("content")String content);
}
